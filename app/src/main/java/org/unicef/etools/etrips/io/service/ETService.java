package org.unicef.etools.etrips.io.service;
...
import org.unicef.etools.etrips.db.entity.static_data.data.Data;
import org.unicef.etools.etrips.db.entity.static_data.data_2.Data2;
import org.unicef.etools.etrips.db.entity.trip.Trip;
import org.unicef.etools.etrips.db.entity.user.User;
...
import org.unicef.etools.etrips.io.rest.url_connection.HttpRequestManager;
import org.unicef.etools.etrips.io.rest.url_connection.RestHttpClient;
import org.unicef.etools.etrips.io.rest.util.APIUtil;
...
import static org.unicef.etools.etrips.io.rest.util.APIUtil.PROFILE;
        ...
        public void run() {
            ...
            switch (requestType) {
                case HttpRequestManager.RequestType.LOGIN:
                    loginInRequest(url, postEntity, subscriber);
                    break;

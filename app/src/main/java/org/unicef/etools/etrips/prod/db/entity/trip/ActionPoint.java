...
public class ActionPoint extends RealmObject {
    ...
    @Expose
    @SerializedName("person_responsible_name")
    ...
    public ActionPoint(long pk, long id, String actionPointNumber, String tripReferenceNumber,
                       ...
                       String createdAt, long assignedBy, String assignedByName, String personResponsibleName,
                       String assignedByFullName, long tripId) {
        this.pk = pk;
        this.id = id;

...
public abstract class Event {
    ...
    public static class EventType {
        ...
        public static class Api {
            public static final int TOKEN_REQUEST_COMPLETED = 100;
            ...
            public static final int WBS_GRANTS_FUNDS_LOADED = 107;
            ...
            public static final int CURRENCIES_LOADED = 114;
        ...
        public static class ChangeData {
            public static final int STOP_LOADING_USERS = 400;
        }
    }

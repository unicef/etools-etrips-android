...
import org.unicef.etools.etrips.prod.io.rest.url_connection.util.HttpResponseUtil;
...
public class HttpRequestManager {
    ...
    public static HttpConnection executeRequest(Context context, boolean isSoupXml, String requestMethod, String url,
                                                String token, String data) {
        Bundle bundle = new Bundle();
        bundle.putString(RestHttpClient.BundleData.JSON_ENTITY, data);
        bundle.putString(RestHttpClient.BundleData.TOKEN, token);
        bundle.putBoolean(RestHttpClient.BundleData.IS_SOUP_XML, isSoupXml);
        HttpConnection httpConnection = null;

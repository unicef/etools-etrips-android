...
public class PostEntityUtil {
    ...
    public static HashMap<String, Object> composeChangeStatusEntity(String rejectionNote) {
        HashMap<String, Object> objectHashMap = new HashMap<>();
        objectHashMap.put("rejection_note", rejectionNote != null ? (rejectionNote.isEmpty() ? null : rejectionNote) : null);

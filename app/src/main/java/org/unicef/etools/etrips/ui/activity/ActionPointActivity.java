...
import org.unicef.etools.etrips.db.entity.DateWrapper;
import org.unicef.etools.etrips.db.entity.PersonResponsibleWrapper;
...
import org.unicef.etools.etrips.util.manager.EmptyDialogClickListener;
        ...
        Realm.getDefaultInstance().executeTransaction(new Realm.Transaction() {
            ...
            public void execute(Realm realm) {
                if (op == EDIT) {
                    ...
                    // Our ActionPoint has only id, not full name, sso we must retrieve it from db.
                    mPersonResponsibleFullName = realm.where(UserStatic.class)
                            .equalTo("id", mActionPoint.getPersonResponsible())
                            .findFirst()
                            .getFullName();
                } else {

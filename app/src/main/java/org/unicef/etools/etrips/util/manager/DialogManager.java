package org.unicef.etools.etrips.util.manager;
...
public class DialogManager {
    ...
    public class DialogIdentifier {
        ...
        public static final int LOGOUT_DIALOG = 2;
    ...
    private String getPositiveButtonText(int identifier) {
        switch (identifier) {
            ...
            case DialogIdentifier.LOGOUT_DIALOG:
                return DialogButtonText.LOGOUT;

            case DialogIdentifier.STATUS_DIALOG:
                return DialogButtonText.OK;
        }
        return null;
    }
    ...
    public void showPreloader(Context context, String launchingClass) {

        if (!((Activity) context).isFinishing()) {
            // otherwise WindowManager$BadTokenException: Unable to add window will be thrown

            mContextClassName = launchingClass;

            LayoutInflater inflater = (LayoutInflater) context.getSystemService(
                    Context.LAYOUT_INFLATER_SERVICE);
            View view = inflater.inflate(R.layout.layout_preloader, null);
